"""Run raw TemplateMatching on the manifest's development split only."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=PROJECT_ROOT / "outputs" / "metrics" / "template_matching_development.csv",
    )
    parser.add_argument(
        "--summary",
        type=Path,
        default=PROJECT_ROOT / "outputs" / "metrics" / "template_matching_development_summary.json",
    )
    parser.add_argument(
        "--iou-threshold",
        type=float,
    ...
    boxes_directory = args.output.parent / "template_matching_development_boxes"
